...
/**
 * A database that stores Shoe information.
...
// Enabling TypeConverters
@TypeConverters(ShoeInventoryTypeConverters::class)
abstract class ShoeDatabase: RoomDatabase() {
    ...
    /**
     * Define a companion object, this allows us to add functions on the ShoeDatabase class.
     *
     * For example, clients can call `ShoeDatabase.getInstance(context)` to instantiate
     * a new SleepDatabase.
     */
    companion object {
        /**
